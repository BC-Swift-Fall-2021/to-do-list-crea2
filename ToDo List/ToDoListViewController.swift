    ...
    func setNotifications() {
        ...
        for index in 0..<toDoItems.itemsArray.count {
            if toDoItems.itemsArray[index].reminderSet {
                ...
                toDoItems.itemsArray[index].notificationID = setCalendarNotification(tile: toDoItem.name, subtitle: "", body: toDoItem.notes, badgeNumber: nil, sound: .default, date: toDoItem.date)
            }
            
        }
    }
    
    func setCalendarNotification(tile: String, subtitle: String, body: String, badgeNumber: NSNumber?, sound: UNNotificationSound?, date: Date) -> String {
