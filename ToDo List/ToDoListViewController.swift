    ...
    func setNotifications() {
        ...
        for index in 0..<toDoItems.count {
            if toDoItems[index].reminderSet {
                ...
                toDoItems[index].notificationID = setCalendarNotification(tile: toDoItem.name, subtitle: "", body: toDoItem.notes, badgeNumber: nil, sound: .default, date: toDoItem.date)
            }
